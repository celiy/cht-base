...
const routes: RouteRecordRaw[] = [
    {
        ...
        children: [
            ...
            },
            {
                path: "docs/usage",
                name: "docs-usage",
                component: () => import("./pages/docs/usage.vue")
            },
            {
                path: "docs/styling",
                name: "docs-styling",
                component: () => import("./pages/docs/styling.vue")
            },
            {
                path: "docs/project",
                name: "docs-project",
            ...
            },
            {
                ...
                component: () => import("./pages/docs/components/badges.vue")
            },
            {
                path: "docs/components/buttons",
                name: "components-buttons",
                component: () => import("./pages/docs/components/buttons.vue")
            },
            {
                path: "docs/components/chat",
                name: "components-chat",
                component: () => import("./pages/docs/components/chat.vue")
            },
            {
            ...
            },
            {
                ...
                component: () => import("./pages/docs/components/carousel.vue")
            },
            {
                path: "docs/components/checkbox",
                name: "components-checkbox",
                component: () => import("./pages/docs/components/checkbox.vue")
            },
            {
                path: "docs/components/context-menu",
                name: "components-context-menu",
                component: () => import("./pages/docs/components/context-menu.vue")
            },
            {
                path: "docs/components/drawer",
                name: "components-drawer",
                component: () => import("./pages/docs/components/drawer.vue")
            },
            {
                path: "docs/components/dropdown",
                name: "components-dropdown",
                component: () => import("./pages/docs/components/dropdown.vue")
            },
            {
            ...
            },
            {
                ...
                name: "components-confirmation-modal",
                component: () => import("./pages/docs/components/confirmation-modal.vue")
            },
            {
                path: "docs/components/pagination",
                name: "components-pagination",
                component: () => import("./pages/docs/components/pagination.vue")
            },
            {
                path: "docs/components/resizable",
                name: "components-resizable",
                component: () => import("./pages/docs/components/resizable.vue")
            },
            {
                path: "docs/components/popover",
                name: "components-popover",
                component: () => import("./pages/docs/components/popover.vue")
            },
            {
                path: "docs/components/progressbar",
                name: "components-progressbar",
                component: () => import("./pages/docs/components/progressbar.vue")
            },
            {
                path: "docs/components/qr-code",
                name: "components-qr-code",
                component: () => import("./pages/docs/components/qr-code.vue")
            },
            {
                path: "docs/components/radio",
                name: "components-radio",
                component: () => import("./pages/docs/components/radio.vue")
            },
            {
            ...
            },
            {
                ...
                component: () => import("./pages/docs/components/sidebar.vue")
            },
            {
                path: "docs/components/steps",
                name: "components-steps",
                component: () => import("./pages/docs/components/steps.vue")
            },
            {
            ...
            },
            {
                ...
                component: () => import("./pages/docs/components/table.vue")
            },
            {
            ...
            {
                path: "docs/components/form-renderer",
                name: "components-form-renderer",
                component: () => import("./pages/docs/components/form-renderer.vue")
            },
            {
            ...
            },
            {
                ...
                component: () => import("./pages/docs/components/colors.vue")
            },
            {
                path: "docs/components/typography",
                name: "components-typography",
                component: () => import("./pages/docs/components/typography.vue")
            },
            {
                path: ":pathMatch(.*)*",
                name: "not-found",
